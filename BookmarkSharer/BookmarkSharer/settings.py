"""
Django settings for BookmarkSharer project.
...
SECRET_KEY = '-)*2bwd2zlk=ia3(snf(3*#&=lr4f^ra7c+u4esy54y*%6_iio'
...
ROOT_URLCONF = 'BookmarkSharer.urls'
...
WSGI_APPLICATION = 'BookmarkSharer.wsgi.application'
